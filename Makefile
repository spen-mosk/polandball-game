...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile 2dpainting.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		player.cpp \
		platform.cpp \
		movingplatform.cpp moc_window.cpp \
		moc_gamewidget.cpp \
		moc_player.cpp
OBJECTS       = main.o \
		window.o \
...
Makefile: 2dpainting.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile 2dpainting.pro
...
dist: 
	@test -d .tmp/2dpainting1.0.0 || mkdir -p .tmp/2dpainting1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/2dpainting1.0.0/ && $(COPY_FILE) --parents window.h actor.h camera.h level.h gamewidget.h gameobject.h player.h platform.h movingplatform.h .tmp/2dpainting1.0.0/ && $(COPY_FILE) --parents main.cpp window.cpp actor.cpp camera.cpp level.cpp gamewidget.cpp gameobject.cpp player.cpp platform.cpp movingplatform.cpp .tmp/2dpainting1.0.0/ && (cd `dirname .tmp/2dpainting1.0.0` && $(TAR) 2dpainting1.0.0.tar 2dpainting1.0.0 && $(COMPRESS) 2dpainting1.0.0.tar) && $(MOVE) `dirname .tmp/2dpainting1.0.0`/2dpainting1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/2dpainting1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_window.cpp moc_gamewidget.cpp moc_player.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_window.cpp moc_gamewidget.cpp moc_player.cpp
...
moc_gamewidget.cpp: /usr/include/qt5/QtCore/QTimer \
		...
		gamewidget.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include gamewidget.h -o moc_gamewidget.cpp

moc_player.cpp: /usr/include/qt5/QtCore/QSet \
		/usr/include/qt5/QtCore/qset.h \
		/usr/include/qt5/QtCore/qhash.h \
		/usr/include/qt5/QtCore/qchar.h \
		/usr/include/qt5/QtCore/qglobal.h \
...
window.o: window.cpp gamewidget.h \
...
movingplatform.o: movingplatform.cpp movingplatform.h \
		...
		/usr/include/qt5/QtGui/qfont.h \
		/usr/include/qt5/QtGui/qfontmetrics.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o movingplatform.o movingplatform.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/opengl/2dpainting || mkdir -p $(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/opengl/2dpainting
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/opengl/2dpainting/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/opengl/2dpainting/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/opengl/2dpainting/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/lib/x86_64-linux-gnu/qt5/examples/opengl/2dpainting/ 
