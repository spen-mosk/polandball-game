...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/2dpainting1.0.0/ && $(COPY_FILE) --parents glwidget.h window.h actor.h .tmp/2dpainting1.0.0/ && $(COPY_FILE) --parents glwidget.cpp main.cpp window.cpp actor.cpp .tmp/2dpainting1.0.0/ && (cd `dirname .tmp/2dpainting1.0.0` && $(TAR) 2dpainting1.0.0.tar 2dpainting1.0.0 && $(COMPRESS) 2dpainting1.0.0.tar) && $(MOVE) `dirname .tmp/2dpainting1.0.0`/2dpainting1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/2dpainting1.0.0
